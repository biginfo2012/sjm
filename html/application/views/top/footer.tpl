...
{/foreach}
	 ...
	 <li class="layout--li fix--90" style='width:100px'>
      ...
      <div class="sct">
        ...
        <div class="responsive_part" style="position: absolute; right: 0; top: -2rem; width: 55%; color: gray;">
          <p style="white-space: pre-line">※他社情報（例：営業の動向、イベント、インセンティブ情報、新製品情報、リコール情報、他社使用感 など）、使用メーカー選定理由 / ABTを使用しない理由、Drからの要望などの情報獲得し、次のアクションが具体化すること
※面談内容と次のアクションをフリーコメント欄に記入すること</p>
        </div>
      </div>
